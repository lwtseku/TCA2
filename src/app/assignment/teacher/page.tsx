...
export default function TeacherPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f181e] px-6 py-10 text-gray-700 dark:text-gray-200 flex flex-col lg:flex-row gap-10">
      {/* Зүүн тал - Даалгавар үүсгэх */}
      <div className="flex-1 bg-gray-100 dark:bg-[#13272e] p-8 rounded-xl border dark:border-[#264144] shadow-md hover:shadow-[0_0_15px_#5584c6] dark:hover:shadow-[0_0_20px_#6be4b9] transition-all">
        ...
        <form onSubmit={handleAssignmentSubmit} className="space-y-4 text-base">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-md bg-white dark:bg-[#264144] border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 placeholder:text-gray-400 focus:outline-none"
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 rounded-md bg-white dark:bg-[#264144] border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200"
            >
              {[1, 2, 3, 4, 5].map((i) => (
      ...
      <div className="w-full lg:w-[400px] bg-gray-100 dark:bg-[#13272e] rounded-xl border dark:border-[#264144] p-6 shadow-xl">
        ...
        <div className="space-y-4">
          {submissions.length === 0 ? (
            ...
            submissions.map((s) => (
              <div
                key={s.id}
                className="bg-white dark:bg-[#264144] p-4 rounded-md border dark:border-gray-600 shadow-md"
              >
                ...
                <div className="flex gap-2 items-center">
                  <input
                    ...
                    className="w-16 px-1 py-1 bg-white dark:bg-[#355264] border border-gray-300 dark:border-gray-600 rounded text-gray-700 dark:text-gray-200 text-sm"
                    placeholder="Оноо"
                  />
                  <button
                    onClick={() => handleScoreSubmit(s.id)}
                    className="bg-[#5584c6] dark:bg-[#6be4b9] hover:bg-[#406dab] dark:hover:bg-[#57c5a5] text-white text-sm px-3 py-1 rounded font-semibold shadow-md transition"
                  >
                    Үнэлэх
                  </button>
                </div>
